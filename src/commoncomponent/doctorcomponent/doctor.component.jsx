...
import { ArrowRightCircle,BoxArrowRight,Google,PersonFill } from 'react-bootstrap-icons';
import { Link } from 'react-router-dom';
import './doctor.component.css';

export function Doctorcomonent() {
  ...
  return (
    <div>
      ...
      <div className="showform">
        <button onClick={() => setShowForm(!showForm)}  className="btn btn-primary">Add Doctor</button>
      </div>
