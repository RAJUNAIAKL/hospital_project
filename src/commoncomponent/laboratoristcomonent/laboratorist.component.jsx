...
import './laboratorist.component.css';

export function Laboratristcomponent() {
  ...
  return (
    <div>
      ...
      <div className="showform">
        <button onClick={() => setShowForm(!showForm)}  className="btn btn-primary">Add Laboratrist</button>
      </div>
      ...
      {showForm && (
        ...
        <form method="post" action="http://localhost:4000/saveDoctordata">
          ...
          <div>
            ...
            <input type="text" className="form-control w-50" style={{ width: '980px',marginLeft:"80px"  }} id="namejs" ref={nameref} name="name"></input>
          </div>

          <div className="mt-3">
            <label style={{ fontSize: '20px' }}>Description</label>
            <textarea type="text" className="form-control" id="descjs" style={{ width: '55%' }} ref={descref} name="description"></textarea>
          </div>

          <div className="mt-3">
            <input type="submit" className="btn btn-success"  value={savebtn} style={{ backgroundColor: 'green', color: 'white', width: '99px', fontSize: '16px', padding: '4px', borderRadius: '16px' }}></input>
            &nbsp;&nbsp;&nbsp;&nbsp;

            <input type="button" value="cancel" className="btn btn-danger" 
              style={{ backgroundColor: 'red', color: 'white', width: '99px', fontSize: '16px', padding: '4px', borderRadius: '20px' }} onClick={() => {
                clearDoctordata()
              }}></input>
