...
import './pharmacist.compopnent.css';

export function Pharmaicstcomponent() {
  ...
  return (
    <div>
      ...
      <div className="showform">
        <button onClick={() => setShowForm(!showForm)}  className="btn btn-primary">Add Pharmaicst</button>
      </div>
